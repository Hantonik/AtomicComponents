...
public class AtomicFluidTagsProvider extends FluidTagsProvider {
    ...
    protected void addTags() {
        this.tag(AtomicFluids.MOLTEN_ALUMINUM.getLocalTag()).add(AtomicFluids.MOLTEN_ALUMINUM.get(), AtomicFluids.MOLTEN_ALUMINUM.getFlowing());
        this.tag(AtomicFluids.MOLTEN_ALUMINUM.getForgeTag()).addTag(AtomicFluids.MOLTEN_ALUMINUM.getLocalTag());
